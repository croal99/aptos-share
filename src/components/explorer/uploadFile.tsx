...
export default function UploadFile(
    ...
    const handleSubmit = async (event) => {
        ...
        if (file.type.indexOf('image') == -1) {
            toast.error('Aptos Share can only share image files. If you want to share more types of files, please order the pro version.', {
                duration: 5000
            });
            setStep(0);
            return
        ...
        axios.put(publisherUrl, resultbytes, config).then(response => {
            ...
            if (response.data.alreadyCertified) {
                ...
                toast.success("Blob file created successfully")
            } else {
                setUploadProgress(0);
                setStep(0);
            ...
            setUploadProgress(0);
            setStep(0);
            setMessage('Please check your network configuration is correct.');
            setIsError(true)
        })
    ...
    return (
        <>
            ...
            <Dialog.Root open={step == 1}>
                <Dialog.Content maxWidth="550px">
                    ...
                    <Flex direction="column" gap="3">
                        <Text>
                            Aptos Share uses javascript running within your web browser to encrypt and decrypt
            ...
            <Dialog.Root open={step == 2}>
                <Dialog.Content maxWidth="550px">
                    <Dialog.Title>Step 2: Upload encrypted files to Aptos Disk</Dialog.Title>
                    <Dialog.Description size="2" mb="4">
                    </Dialog.Description>
                            ...
                            <Card style={{background: 'var(--gray-a6)'}}>
                                <Flex direction="column" gap="3">
                                    ...
                                    <Text color="red">
                                        ...
                                        you want
                                        to upload larger
                                        files, please order the pro version.
                                    </Text>
                                </Flex>
                            </Card> : null}
                        {uploadProgress < 100 ?
